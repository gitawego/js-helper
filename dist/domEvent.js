(function (factory) {
    if (typeof define === "function" && define.amd) {
        define(["exports", "module", "./touch"], factory);
    } else if (typeof exports !== "undefined" && typeof module !== "undefined") {
        factory(exports, module, require("./touch"));
    }
})(function (exports, module, _touch) {
    "use strict";

    var _interopRequire = function (obj) { return obj && obj.__esModule ? obj["default"] : obj; };

    var touch = _interopRequire(_touch);
    ...
    var delegate = {
        ...
        _on: function (node, evtName, callback, type, once) {
            var cb = callback,
                isList = node instanceof NodeList || node instanceof HTMLCollection,
                _evtName,
                evtLowerCase,
                i = 0,
                l;
        ...
        buildEvent: function (evtName, params) {
            ...
            eventType = isMouseEvent ? "initMouseEvent" : "initEvent",
                eventObj;
            ...
            if (eventObj[eventType]) {
                eventObj[eventType](evtName, "canBubble" in params ? params.canBubble : true, "cancelable" in params ? params.cancelable : true, params.view || window);
            }
